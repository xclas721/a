<template>
  <!-- <div class="d-flex justify-content-between align-items-center mb-3">
    <h4>{{ $t('ui.menu.report_realtime_visa') }}</h4>
  </div> -->
...
const grafanaDashboardUrl = '/report_realtime_visa/getGrafanaUrlWithAuthToken'
...
const grafanaVariables = [
  {
    param: 'var-visaRbaScoreDistributionTitle',
    i18nKey: 'ui.grafana.panel.visaRbaScoreDistribution.title'
  },
  {
    param: 'var-visaRbaTransactionDetailsTitle',
    i18nKey: 'ui.grafana.panel.visaRbaTransactionDetails.title'
  },
  {
    param: 'var-scoreDistributionName',
    i18nKey: 'ui.grafana.panel.scoreDistribution.name'
  },
  {
    param: 'var-visaRbaTransactionDetailsName',
    i18nKey: 'ui.grafana.panel.visaRbaTransactionDetails.name'
  }
