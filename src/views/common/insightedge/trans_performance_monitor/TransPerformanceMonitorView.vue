<template>
  <!-- <div class="d-flex justify-content-between align-items-center mb-3">
    <h4>{{ $t('ui.menu.trans_performance_monitor') }}</h4>
  </div> -->
...
const grafanaDashboardUrl = '/trans_performance_monitor/getGrafanaUrlWithAuthToken'
...
const grafanaVariables = [
  {
    param: 'var-areqTitle',
    i18nKey: 'ui.grafana.panel.areq.name'
  },
  {
    param: 'var-creqTitle',
    i18nKey: 'ui.grafana.panel.creq.name'
  },
  {
    param: 'var-rreqTitle',
    i18nKey: 'ui.grafana.panel.rreq.name'
  },
  {
    param: 'var-cavvTitle',
    i18nKey: 'ui.grafana.panel.cavv.name'
  },
  {
    param: 'var-otpTitle',
    i18nKey: 'ui.grafana.panel.otp.name'
  },
  {
    param: 'var-rbaTitle',
    i18nKey: 'ui.grafana.panel.rba.name'
  },
  {
    param: 'var-p95Title',
    i18nKey: 'ui.grafana.panel.p95.name'
  },
  {
    param: 'var-p50Title',
    i18nKey: 'ui.grafana.panel.p50.name'
  }
