...
const grafanaDashboardUrl = '/report_realtime_mastercard/getGrafanaUrlWithAuthToken'
...
const grafanaVariables = [
  {
    param: 'var-decisionProportionTitle',
    i18nKey: 'ui.grafana.panel.decisionProportion.name'
  },
  {
    param: 'var-mastercardDecisionTrendsTitle',
    i18nKey: 'ui.grafana.panel.mastercardDecisionTrends.name'
  },
  {
    param: 'var-lowRiskFrictionlessRateTitle',
    i18nKey: 'ui.grafana.panel.lowRiskFrictionlessRate.name'
  },
  {
    param: 'var-lowRiskDailyTrendTitle',
    i18nKey: 'ui.grafana.panel.lowRiskDailyTrend.name'
  },
  {
    param: 'var-mastercardScoreDistributionTitle',
    i18nKey: 'ui.grafana.panel.mastercardScoreDistribution.name'
  },
  {
    param: 'var-mastercardTransactionDetailsTitle',
    i18nKey: 'ui.grafana.panel.mastercardTransactionDetails.name'
  }
