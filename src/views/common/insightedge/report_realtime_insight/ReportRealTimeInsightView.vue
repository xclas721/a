<template>
  <!-- <div class="d-flex justify-content-between align-items-center mb-3">
    <h4>{{ $t('ui.menu.report_realtime_insight') }}</h4>
  </div> -->
...
const grafanaDashboardUrl = '/report_realtime_insight/getGrafanaUrlWithAuthToken'
...
const grafanaVariables = [
  {
    param: 'var-distinctAcctNumberCountTitle',
    i18nKey: 'ui.grafana.panel.distinctAcctNumberCount.name'
  },
  {
    param: 'var-cardbin6StatsTitle',
    i18nKey: 'ui.grafana.panel.cardbin6Stats.name'
  },
  {
    param: 'var-transactionBrowserIpGeoDistribution',
    i18nKey: 'ui.grafana.panel.transactionBrowserIpGeoDistribution.name'
  },
  {
    param: 'var-acctNumberTransDetailTitle',
    i18nKey: 'ui.grafana.panel.acctNumberTransDetail.name'
  },
  {
    param: 'var-top20UsdAmountDetailTitle',
    i18nKey: 'ui.grafana.panel.top20UsdAmountDetail.name'
  },
  {
    param: 'var-top20MerchantStatsTitle',
    i18nKey: 'ui.grafana.panel.top20MerchantStats.name'
  },
  {
    param: 'var-top10CountryStatsTitle',
    i18nKey: 'ui.grafana.panel.top10CountryStats.name'
  }
