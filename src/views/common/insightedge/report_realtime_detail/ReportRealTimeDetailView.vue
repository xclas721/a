...
const grafanaDashboardUrl = '/report_realtime_detail/getGrafanaUrlWithAuthToken'
...
const grafanaVariables = [
  {
    param: 'var-cardSchemeDistributionTitle',
    i18nKey: 'ui.grafana.panel.cardSchemeDistribution.name'
  },
  {
    param: 'var-cardSchemeTrendsTitle',
    i18nKey: 'ui.grafana.panel.cardSchemeTrends.name'
  },
  {
    param: 'var-messageCategoryDistributionTitle',
    i18nKey: 'ui.grafana.panel.messageCategoryDistribution.name'
  },
  {
    param: 'var-messageCategoryTrendsTitle',
    i18nKey: 'ui.grafana.panel.messageCategoryTrends.name'
  },
  {
    param: 'var-deviceChannelDistributionTitle',
    i18nKey: 'ui.grafana.panel.deviceChannelDistribution.name'
  },
  {
    param: 'var-deviceChannelTrendsTitle',
    i18nKey: 'ui.grafana.panel.deviceChannelTrends.name'
  },
  {
    param: 'var-authenticationMethodDistributionTitle',
    i18nKey: 'ui.grafana.panel.authenticationMethodDistribution.name'
  },
  {
    param: 'var-authenticationMethodTrendsTitle',
    i18nKey: 'ui.grafana.panel.authenticationMethodTrends.name'
  }
