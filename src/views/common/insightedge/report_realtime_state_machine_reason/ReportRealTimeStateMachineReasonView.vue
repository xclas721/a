...
const grafanaDashboardUrl = '/report_realtime_state_machine_reason/getGrafanaUrlWithAuthToken'
...
const grafanaVariables = [
  {
    param: 'var-stateMachineReasonStatisticsTitle',
    i18nKey: 'ui.grafana.panel.StateMachineReasonStatistics.name'
  },
  {
    param: 'var-stateMachineReasonTrendTitle',
    i18nKey: 'ui.grafana.panel.StateMachineReasonTrend.name'
  },
  {
    param: 'var-stateMachineReasonDetailTitle',
    i18nKey: 'ui.grafana.panel.StateMachineReasonDetail.name'
  }
]
