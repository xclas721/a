<template>
  <!-- <div class="d-flex justify-content-between align-items-center mb-3">
    <h4>{{ $t('ui.menu.report_realtime_error') }}</h4>
  </div> -->
...
const grafanaDashboardUrl = '/report_realtime_error/getGrafanaUrlWithAuthToken'
...
const grafanaVariables = [
  {
    param: 'var-acsErrorCountTitle',
    i18nKey: 'ui.grafana.panel.acsErrorCount.name'
  },
  {
    param: 'var-dsErrorCountTitle',
    i18nKey: 'ui.grafana.panel.dsErrorCount.name'
  },
  {
    param: 'var-3dssErrorCountTitle',
    i18nKey: 'ui.grafana.panel.3dssErrorCount.name'
  },
  {
    param: 'var-sdkErrorCountTitle',
    i18nKey: 'ui.grafana.panel.sdkErrorCount.name'
  },
  {
    param: 'var-acsErrorTrendsTitle',
    i18nKey: 'ui.grafana.panel.acsErrorTrends.name'
  },
  {
    param: 'var-dsErrorTrendsTitle',
    i18nKey: 'ui.grafana.panel.dsErrorTrends.name'
  },
  {
    param: 'var-3dssErrorTrendsTitle',
    i18nKey: 'ui.grafana.panel.3dssErrorTrends.name'
  },
  {
    param: 'var-sdkErrorTrendsTitle',
    i18nKey: 'ui.grafana.panel.sdkErrorTrends.name'
  },
  {
    param: 'var-errorCodeSummaryTitle',
    i18nKey: 'ui.grafana.panel.errorCodeSummary.name'
  }
]
