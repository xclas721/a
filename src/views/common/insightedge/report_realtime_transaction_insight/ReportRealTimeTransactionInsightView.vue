<template>
  <!-- <div class="d-flex justify-content-between align-items-center mb-3">
    <h4>{{ $t('ui.menu.report_realtime_transaction_insight') }}</h4>
  </div> -->
...
const grafanaDashboardUrl = '/report_realtime_transaction_insight/getGrafanaUrlWithAuthToken'
...
const grafanaVariables = [
  {
    param: 'var-cardbinAcctNumberCountTitle',
    i18nKey: 'ui.grafana.panel.transInsight.cardbinAcctNumberCount.name'
  },
  {
    param: 'var-cardbin6StatsTitle',
    i18nKey: 'ui.grafana.panel.transInsight.cardbin6Stats.name'
  },
  {
    param: 'var-top20MerchantStatsTitle',
    i18nKey: 'ui.grafana.panel.transInsight.top20MerchantStats.name'
  },
  {
    param: 'var-merchantCountryStatsTitle',
    i18nKey: 'ui.grafana.panel.transInsight.merchantCountryStats.name'
  },
  {
    param: 'var-top20UsdAmountDetailTitle',
    i18nKey: 'ui.grafana.panel.transInsight.top20UsdAmountDetail.name'
  },
  {
    param: 'var-acctNumberTransDetailTitle',
    i18nKey: 'ui.grafana.panel.transInsight.acctNumberTransDetail.name'
  },
  {
    param: 'var-transactionMerchantCountryGeoDistributionTitle',
    i18nKey: 'ui.grafana.panel.transInsight.transactionMerchantCountryGeoDistribution.name'
  },
  {
    param: 'var-cardbinAcctNumberCountDescription',
    i18nKey: 'ui.grafana.panel.transInsight.cardbinAcctNumberCount.description'
  },
  {
    param: 'var-cardbin6StatsDescription',
    i18nKey: 'ui.grafana.panel.transInsight.cardbin6Stats.description'
  }
]
