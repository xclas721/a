  ...
  <div class="col-md-12 mt-3">
    ...
    <div class="content-box-query p-3">
      <div class="row">
        <!-- After change -->
        <div class="col-md-4">
          <span class="form-label d-block">{{ $t('ui.eea-region.countryCode') }}</span>
          <p>
            <span>{{ valOrNA(data.countryCode) }}</span>
          </p>
          <hr />
        </div>

        <div class="col-md-4">
          <span class="form-label d-block">{{ $t('ui.eea-region.eeaCountry') }}</span>
          <p>
            <span>{{ valOrNA(data.eeaCountry) }}</span>
          </p>
          <hr />
        </div>
      </div>
