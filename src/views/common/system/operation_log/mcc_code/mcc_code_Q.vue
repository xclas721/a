  ...
  <div class="col-md-12 mt-3">
    ...
    <div class="content-box-query p-3">
      <div class="row">
        <!-- After change -->
        <div class="col-md-4">
          <span class="form-label d-block">{{ $t('ui.mcc-code.mcc') }}</span>
          <p>
            <span>{{ valOrNA(data.criteriaMcc) }}</span>
          </p>
          <hr />
        </div>

        <div class="col-md-4">
          <span class="form-label d-block">{{ $t('ui.mcc-code.merchantType') }}</span>
          <p>
            <span>{{ valOrNA(data.criteriaMerchantType) }}</span>
          </p>
          <hr />
        </div>
      </div>
