  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-12">
        ...
        <p>
          <span :class="{ 'text-danger': isDifferent(dataAfter.certIssuerCn, dataBefore.certIssuerCn) }">
      ...
      <div class="col-md-12">
        ...
        <p>
          <span :class="{ 'text-danger': isDifferent(dataAfter.notAfter, dataBefore.notAfter) }">
            {{ valOrNA(dataAfter.notAfter) }}
          </span>
        </p>
        <hr />
      </div>
