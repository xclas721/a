  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <template v-if="detailData.action != 'U'">
          ...
          <div class="row">
            <div class="col-md-4">
              <p :class="{ 'text-danger': isDifferent(dataAfter.switchVisa, dataBefore.switchVisa) }">
                {{ $t('ui.issuer-param.switchVisa.' + dataAfter.switchVisa) }}
              </p>
            </div>
            <div class="col-md-4">
              <p
              ...
              >
                {{ $t('ui.issuer-param.switchMastercard.' + dataAfter.switchMastercard) }}
              </p>
            </div>
            <div class="col-md-4">
              <p :class="{ 'text-danger': isDifferent(dataAfter.switchJcb, dataBefore.switchJcb) }">
                {{ $t('ui.issuer-param.switchJcb.' + dataAfter.switchJcb) }}
              </p>
            </div>
            <div class="col-md-4">
              <p :class="{ 'text-danger': isDifferent(dataAfter.switchAmex, dataBefore.switchAmex) }">
                {{ $t('ui.issuer-param.switchAmex.' + dataAfter.switchAmex) }}
              </p>
            </div>
            <div class="col-md-4">
              <p
              ...
              >
                {{ $t('ui.issuer-param.switchDiners.' + dataAfter.switchDiners) }}
              </p>
            </div>
            <div class="col-md-4">
              <p :class="{ 'text-danger': isDifferent(dataAfter.switchCup, dataBefore.switchCup) }">
                {{ $t('ui.issuer-param.switchCup.' + dataAfter.switchCup) }}
              </p>
            </div>
            <div class="col-md-4">
              <p
              ...
              >
                {{ $t('ui.issuer-param.switchPayNet.' + dataAfter.switchPayNet) }}
              </p>
            </div>
            <div class="col-md-4">
              <p :class="{ 'text-danger': isDifferent(dataAfter.switchMada, dataBefore.switchMada) }">
                {{ $t('ui.issuer-param.switchMada.' + dataAfter.switchMada) }}
              </p>
            </div>
            <div class="col-md-4">
              <p
              ...
              >
                {{ $t('ui.issuer-param.switchEftPos.' + dataAfter.switchEftPos) }}
              </p>
            </div>
            <div class="col-md-4">
              <p :class="{ 'text-danger': isDifferent(dataAfter.switchTpn, dataBefore.switchTpn) }">
                {{ $t('ui.issuer-param.switchTpn.' + dataAfter.switchTpn) }}
              </p>
            </div>
          </div>
          <hr />
        ...
        <div class="col-md-12">
          <span class="form-label d-block">{{ $t('ui.trans.log.acsOperatorId') }}</span>
          <p>
            <span
              :class="{
