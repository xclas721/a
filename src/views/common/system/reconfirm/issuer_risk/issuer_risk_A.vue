  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <div class="col-md-12">
        ...
        <div v-if="dataAfter.bankId">
          <input class="form-control" readonly :value="getIssuerName(dataAfter.bankId)" />
        </div>
        <div v-else>
                    ...
                    <tr v-for="(context, contextIndex) in subject.contexts" :key="contextIndex" class="context">
                      ...
                      <td>
                        ...
                        <div v-for="(option, optionIndex) in context.options" :key="optionIndex" class="text-nowrap">
                          ...
                          <span v-if="option.i18n == 'ui.rba.topic.1-1-1.option.2.medium'">
                            ...
                            <span v-for="rbaCustom in dataAfter.rbaCustomContextDTOList" :key="rbaCustom.oid">
                              <span v-if="rbaCustom.i18n == context.i18n">
                                <span
                                  :class="{
                                    'text-danger':
                                      itemsMap.get(rbaCustom.i18n).params[0].dataValue != rbaCustom.params[0].dataValue
                                  }"
                                >
                                  {{ rbaCustom.params[0].dataValue }}
                                </span>
                              </span>
                            </span>
                            ...
                            <span v-for="rbaCustom in dataAfter.rbaCustomContextDTOList" :key="rbaCustom.oid">
                              <span v-if="rbaCustom.i18n == context.i18n">
                                <span
                                  ...
                                  >{{ rbaCustom.params[0].dataValue }}</span
                                ></span
                              >
                            </span>
                            ...
                            <span v-for="rbaCustom in dataAfter.rbaCustomContextDTOList" :key="rbaCustom.oid">
                              <span v-if="rbaCustom.i18n == context.i18n"
                                ><span
                                  ...
                                  >{{ rbaCustom.params[1].dataValue }}</span
                                ></span
                              >
                            </span>
                        ...
                        <div style="margin-top: 0.5em">
                          ...
                          <textarea
                            ...
                            disabled
                            :class="{
                              'text-danger': itemsMap.get(context.i18n).customerStatement != context.customerStatement
                            }"
                          ></textarea>
                        </div>
                      </td>
                      ...
                      <td class="text-center" style="width: 5%">
                        ...
                        <div v-for="(score, index) in context.scores" :key="index">
                          <span
                            class="score-readonly"
                            :class="{
                              'text-danger': itemsMap.get(context.i18n).scores[index].score != score.score
                            }"
                          >
                            {{ score.score }}
                          </span>
                        ...
                        <div style="margin-top: 0.5em">
                          ...
                          <div
                            class="text-warning important-editable hidden"
                            :class="{
                              'text-danger': itemsMap.get(context.i18n).importance != context.importance
                            }"
                          >
...
onMounted(async () => {
  ...
  threshold.value = props.dataAfter.rbaDataIssuerFormReq.threshold ?? {}
})
...
function filterContexts(contexts: Record<string, any>[], validContexts: string[]): Record<string, any>[] {
  for (const item of props.dataAfter.rbaCustomContextDTOList) {
...
function fetchAndFilterData() {
  ...
  const rawTopics = props.dataAfter.rbaStaticIssuerFormReq.topicList
  const validTopics = props.dataAfter.rbaDataIssuerFormReq.header1List
  const validSubjects = props.dataAfter.rbaDataIssuerFormReq.header2List
  const validContexts = props.dataAfter.rbaDataIssuerFormReq.contextList
  // Apply filter
