    ...
    <div class="col-md-12">
      <div v-if="detailData.action === 'E' || detailData.action === 'O'">
        ...
        <div class="col-md-12">
          ...
          <p>
            <span
              :class="{
                'text-danger': isDifferent(dataAfter.subjectCn, dataBefore.subjectCn)
              }"
            >
              {{ valOrNA(dataAfter.subjectCn) }}
            </span>
          </p>
          <hr />
        </div>
        ...
        <div class="col-md-12">
          <span class="form-label d-block">{{ $t('ui.ca-cert-certificate-cert-issuer-cn') }}</span>
          <p>
            <span
              :class="{
                'text-danger': isDifferent(dataAfter.certIssuerCn, dataBefore.certIssuerCn)
              }"
            >
              {{ valOrNA(dataAfter.certIssuerCn) }}
            </span>
          </p>
          <hr />
        </div>
        ...
        <div class="col-md-12">
          ...
          <p>
            <span :class="{ 'text-danger': isDifferent(dataAfter.validPeriod, dataBefore.validPeriod) }">
              {{ valOrNA(dataAfter.validPeriod) }}
            </span>
          </p>
          <hr />
        </div>
        ...
        <div class="col-md-12">
          ...
          <p>
            <span :class="{ 'text-danger': isDifferent(dataAfter.status, dataBefore.status) }">
              {{ getOptionsByValue(dataAfter.status, enableORDisableOptions) }}
            </span>
          </p>
          <hr />
        </div>
      ...
      <div v-if="detailData.action == 'A'">
        ...
        <div class="col-md-12">
          ...
          <p>
            <span :class="{ 'text-danger': isDifferent(dataAfter.certEncode, dataBefore.certEncode) }">
              {{ getOptionsByValue(dataAfter.certEncode, certEncodeOptionSelect) }}
            </span>
          </p>
          <hr />
        </div>
