<template>
  ...
  <QueryCriteriaComponent
    ...
    :title="$t('ui.report.rba-trans-blacklist')"
    @search="handleSearch"
...
const customButtonList: CustomButton[] = [
  {
    ...
    action: async () => {
      ...
      const apiUtil = new ApiUtil({ showModel: (params: any) => console.log(params) })
      apiUtil
        .downloadExcel('/black_list_trans/export', searchCriteria.value, {})
        .then(() => {
...
const searchResultsHeader = ref<any>([
  {
    header: 'ui.report.rba-trans-blacklist-data',
    field: 'date'
  },
  {
    header: 'ui.report.rba-trans-blacklist-transtotal',
    field: 'transTotal'
  },
  {
    header: 'ui.report.rba-trans-blacklist-blacklisttrans',
    field: 'blackListTrans',
    joinCol: 'blackListTransPercentage',
    joinStr: ' --- '
  },
  {
    header: 'ui.report.rba-trans-blacklist-ip',
    field: 'ip',
    joinCol: 'ipPercentage',
    joinStr: ' --- '
  },
  {
    header: 'ui.report.rba-trans-blacklist-email',
    field: 'email',
    joinCol: 'emailPercentage',
    joinStr: ' --- '
  },
  {
    header: 'ui.report.rba-trans-blacklist-storecode',
    field: 'storeCode',
    joinCol: 'storeCodePercentage',
    joinStr: ' --- '
  },
  {
    header: 'ui.report.rba-trans-blacklist-deviceid',
    field: 'deviceId',
    joinCol: 'deviceIdPercentage',
    joinStr: ' --- '
  },
  {
    header: 'ui.report.rba-trans-blacklist-cardnumber',
    field: 'cardNumber',
    joinCol: 'cardNumberPercentage',
    joinStr: ' --- '
  },
  {
    header: 'ui.report.rba-trans-blacklist-idnumber',
    field: 'idNumber',
    joinCol: 'idNumberPercentage',
    joinStr: ' --- '
  },
  {
    header: 'ui.report.rba-trans-blacklist-phonenumber',
    field: 'phoneNumber',
    joinCol: 'phoneNumberPercentage',
    joinStr: ' --- '
  },
  {
    header: 'ui.report.rba-trans-blacklist-countryoforigin',
    field: 'countryForigin',
    joinCol: 'countryForiginPercentage',
    joinStr: ' --- '
  },
  {
    header: 'ui.report.rba-trans-blacklist-storeurl',
    field: 'storeUrl',
    joinCol: 'storeUrlPercentage',
    joinStr: ' --- '
  },
  {
    header: 'ui.report.rba-trans-blacklist-storecountry',
    field: 'storeCountry',
    joinCol: 'storeCountryPercentage',
    joinStr: ' --- '
  }
])
...
const fetchUserData = async (page: number) => {
  ...
  const result = await apiUtil.postSearchPage('/black_list_trans/query', searchCriteria.value, page, {}, true)
