  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-12">
        ...
        <p>
          <span>
            {{ getOptionsByValue(dataBefore.issuerGroupOid, groupOptions) }}
          </span>
        </p>
        <hr />
      </div>
...
import { getOptionsByValue, handlePwd, valOrNA } from '@/utils/util'
