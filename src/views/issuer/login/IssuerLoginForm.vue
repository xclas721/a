  ...
  <div class="login-form-content">
      ...
      <div class="input-group mb-3">
        <button id="btnFidoLogin" type="button" class="form-control btn-fido" @click="$emit('fido-login')">
          <span class="btn-fido-icon btn-fido-icon-left" aria-hidden="true">
            <i class="ri-qr-scan-ai-line" aria-hidden="true"></i>
          </span>
    ...
    <div class="input-group mb-3">
      ...
      <input
        ...
        required
        autofocus
        :placeholder="$t('ui.login.issuer-bankid.placeholder')"
        @input="$emit('update:bankId', ($event.target as HTMLInputElement).value)"
      />
      <label for="bankId" hidden>{{ $t('ui.login.issuer-bankid') }}</label>
    </div>
    ...
    <div class="input-group mb-3">
      ...
      <label for="inputPassword" hidden>{{ $t('ui.login.password') }}</label>
    </div>
