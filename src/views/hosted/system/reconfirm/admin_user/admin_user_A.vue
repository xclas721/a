    ...
    <div class="col-md-12">
      ...
      <div class="col-md-12">
        ...
        <p>
          ...
          >
            {{ getOptionsByValue(dataAfter.adminGroupOid, issuerGroupData) }}
          </span>
        </p>
        <hr />
      </div>
      ...
      <div class="col-md-12">
        ...
        <p>
          <span :class="{ 'text-danger': isDifferent(dataAfter.pdField, dataBefore.pdField) }">
            {{ handlePwd('*', dataAfter.pdField) }}
          </span>
        </p>
        <hr />
      </div>
      ...
      <div class="col-md-12">
        ...
        <p>
          <span :class="{ 'text-danger': isDifferent(dataAfter.cnfrPdfield, dataBefore.cnfrPdfield) }">
            {{ handlePwd('*', dataAfter.cnfrPdfield) }}
          </span>
        </p>
        <hr />
      </div>
